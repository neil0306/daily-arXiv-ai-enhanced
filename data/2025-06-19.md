...
Motivation: Linguistic ambiguities in dialogues, such as omission and idiom, obscure discourse relations, challenging parsers.

Method: Proposes DCM with two reasoning processes (clarification type and discourse goal reasoning) and CPO to optimize clarifications.

Result: Outperforms SOTA baselines on STAC and Molweni datasets by effectively resolving ambiguities.

Conclusion: The approach enhances parser performance by addressing ambiguities and optimizing clarifications.
...
<details>
  <summary>Details</summary>
Motivation: Addressing challenges of insufficient medical knowledge representation and low clinical deployment efficiency in existing models.
...
Conclusion: CKD-EHR improves clinical resource efficiency and diagnostic accuracy, offering a practical solution for healthcare.
...
Method: Decomposes OD generation into MRG (generating diverse responses) and PS (selecting based on preference). Uses o2mDial corpus, in-context learning, instruction-tuning, and novel metrics for MRG, plus a model-based PS approach.

Result: The framework improves response diversity and quality by up to 90% in smaller LLMs, matching larger models' performance.
...
Conclusion: Thunder-Tok is an effective, linguistically informed approach for efficient tokenizer design.
...
Result: Observed a U-shaped accuracy profile, indicating strong performance at sequence start and end. Validated findings with ablations and perturbations on 1.4B and 7B parameter Mamba models.

Conclusion: The study uncovers distinct memory mechanisms in state-space models, highlighting the roles of sparse encoding, recurrence dynamics, and semantic modulation in memory retention and forgetting.
...
<details>
  <summary>Details</summary>
Motivation: Tracking SDG progress is challenging due to data complexity, necessitating automated text analysis tools like LLMs.
...
Conclusion: Prompt engineering can make smaller LLMs competitive for SDG text classification, offering a cost-effective alternative.
...
<details>
  <summary>Details</summary>
Motivation: Existing QA evaluation methods struggle with semantic nuances, interpretability, and adapting to question types, especially the factoid vs. non-factoid distinction.
...
Conclusion: MinosEval addresses key limitations in open-ended QA evaluation, offering improved accuracy and interpretability.
...
<details>
  <summary>Details</summary>
Motivation: To assess how well current language technologies handle linguistic variation in Basque and Spanish, focusing on dialects and their impact on model performance.

Method: Uses Natural Language Inference (NLI) with a new parallel dataset. Tests crosslingual and in-context learning using encoder-only and decoder-based LLMs.
...
Conclusion: Linguistic variation, especially in dialects like Western Basque, poses challenges for language models, with encoder-only models being most affected. Data and code are publicly available.
...
<details>
  <summary>Details</summary>
Motivation: To bridge domain knowledge gaps in large language models for historical text analysis and reduce manual annotation labor in computational humanities.

Method: Proposes Graph RAG, integrating chain-of-thought prompting, self-instruction generation, and process supervision. Uses knowledge graphs and retrieval-augmented generation for alignment.

Result: Domain-specific model Xunzi-Qwen1.5-14B achieves F1=0.68 in relation extraction. GraphRAG improves F1 by 11% on C-CLUE dataset, reducing hallucinations.

Conclusion: Graph RAG offers a low-resource solution for historical knowledge extraction, enhancing interpretability and advancing humanities research.
...
<details>
  <summary>Details</summary>
Motivation: To enhance question answering over large-scale web corpora by improving answer diversity, relevance, and faithfulness to evidence.

Method: Uses hybrid retrieval (sparse/dense indices), K-Means clustering for semantic grouping, and cluster-specific prompts for LLM-generated answers, followed by filtering and synthesis.
...
Method: Proposes Thunder-DeID: (i) creates a Korean legal dataset with annotated judgments, (ii) introduces systematic PII categorization, and (iii) develops a DNN-based de-identification pipeline.
...
<details>
  <summary>Details</summary>
Motivation: LLMs show promise for improving trial-patient matching due to their knowledge aggregation and reasoning abilities, but adoption in critical domains like clinical trials remains limited.

Method: The survey analyzes trial-patient matching, existing LLM-based approaches, benchmarks, and evaluation frameworks.

Result: Identifies gaps in current LLM applications, such as reliance on proprietary models and inadequate benchmarks, and outlines challenges in clinical research adoption.

Conclusion: The paper calls for better benchmarks and evaluation frameworks to leverage LLMs effectively in clinical trial recruitment, pointing to future research directions.
...
Method: DeVisE uses ICU discharge notes from MIMIC-IV, creating real-world and synthetic versions with controlled counterfactuals for demographics and vital signs. Five LLMs are evaluated under zero-shot and fine-tuned settings.
...
Conclusion: Behavioral testing like DeVisE is crucial for understanding clinical LLMs and designing safer, transparent medical AI.
...
<details>
  <summary>Details</summary>
Motivation: To address the lack of tools assessing language models' comprehension of local socio-cultural contexts, particularly India's rich diversity.

Method: Creation of SANSKRITI, a dataset with 21,853 question-answer pairs covering 16 cultural attributes across India's regions, tested on various language models.

Result: Significant disparities in models' performance, with many struggling in region-specific cultural contexts.
...
Method: Developed COSMMIC dataset with 4,959 article-image pairs and 24,484 comments. Evaluated four configurations using text, comments, images, and combinations, employing models like LLama3 and GPT-4.

Result: Identified effective configurations for NLG tasks by integrating reader insights, filtering noise, and extracting image insights.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the performance gap of LLMs in low-resource languages due to data scarcity and underrepresentation, focusing on cross-lingual lexical alignment.
...
Result: TLI increased average cosine similarity for Swahili-English word pairs by 28.08% (trained) and 28.32% (unseen), demonstrating strong generalization.
...
<details>
  <summary>Details</summary>
Motivation: MLLMs for GUI agents suffer from hallucinations (localization errors), compromising reliability. The paper aims to better understand and mitigate these issues.

Method: Proposes a fine-grained evaluation framework, the Peak Sharpness Score (PSS), and Context-Aware Cropping to improve model performance without training.
...
### [20] [AgentGroupChat-V2: Divide-and-Conquer Is What LLM-Based Multi-Agent System Need](https://arxiv.org/abs/2506.15451)
...
<details>
  <summary>Details</summary>
Motivation: Address challenges in current multi-agent systems like architecture design, generalizability, and performance as task complexity grows.

Method: Introduces three innovations: parallel task decomposition, adaptive collaboration engine, and agent organization optimization.

Result: Achieves high accuracy on benchmarks (e.g., 91.50% on GSM8K, 30.4% on AIME) with notable gains in complex tasks.

Conclusion: AgentGroupChat-V2 is an efficient, general-purpose solution for LLM multi-agent systems, excelling in complex reasoning.
...
Method: Introduces RE-IMAGINE, an automated pipeline generating problem variations at different reasoning levels (associations, interventions, counterfactuals).

Result: Performance drops when LLMs face problem variations, indicating reliance on statistical recall.

Conclusion: The framework highlights LLMs' reasoning limitations and opens research avenues for improving hierarchical reasoning skills.
...
<details>
  <summary>Details</summary>
Motivation: LLMs often fail to ground responses in external context, leading to hallucinations or ungrounded outputs. CINGS aims to ensure better grounding.

Method: Proposes CINGS: post-training supervision where context is prepended to responses, loss is computed only over response tokens, masking context.

Result: CINGS-trained models outperform in 11 text datasets and reduce hallucinations in vision-language tasks, maintaining factual consistency.
...
Result: Improves reasoning performance in offline RL fine-tuning and reward model training, achieving competitive results with greater efficiency.

Conclusion: SPARE offers a scalable and efficient solution for process supervision, with publicly released code for reproducibility.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for hyperbole and metaphor detection focus on superficial features, missing associations and implicit emotions. EmoBi addresses this gap by integrating emotion analysis and domain mapping.

Method: EmoBi uses an emotion analysis module, emotion-based domain mapping, and bidirectional dynamic interaction to detect hyperbole and metaphor, with a verification mechanism for accuracy.

Result: EmoBi achieves significant improvements, with F1 scores increasing by 28.1% for hyperbole and 23.1% for metaphor detection compared to state-of-the-art methods.

Conclusion: The framework demonstrates effectiveness and potential for advancing hyperbole and metaphor detection, supported by experimental results and analyses.
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of generating grounded and trustworthy responses in LLMs, particularly in retrieval-augmented generation (RAG) scenarios where models often fail to cite correctly or refuse valid queries.

Method: Uses GRPO (Group Relative Policy Optimization) for RL training with outcome-based rewards targeting answer correctness, citation sufficiency, and refusal quality. A two-stage training setup is employed, and GPT-4 distillation is revisited for instruction tuning.
...
Conclusion: The study demonstrates the effectiveness of reasoning, stage-wise optimization, and outcome-driven RL for building more verifiable and reliable LLMs.
...
Conclusion: RATTENTION offers a superior Pareto tradeoff, maintaining training efficiency while enhancing performance in short and long-context scenarios.
...
Method: A gradient-based approach selects high-matching data from a large public corpus, tested on classification and supervised-finetuning tasks.

Result: On AG News, performance improved from 65% to 80%, nearing the 88% benchmark. For SFT on MSMARCO, perplexity dropped from 3.3 to 2.3, close to the expert model's 2.0.

Conclusion: The method effectively recovers useful training data from model weights, achieving near-expert performance without access to original data.
...
<details>
  <summary>Details</summary>
Motivation: Address the latency issue in LLM-based voice chat systems, especially on consumer hardware, where delays between user input and audio output degrade user experience.

Method: Proposes Predictive Generation (PredGen), a framework using speculative decoding to generate candidate responses during user speech, enabling earlier TTS processing.

Result: Simulated experiments show PredGen reduces latency by ~2x across various use cases with negligible extra computation.

Conclusion: PredGen effectively mitigates LLM latency in voice chat applications, enhancing user experience without significant computational overhead.
...
Method: Developed GIFI, a multi-level evaluation metric, and tested it on 22 open-source and proprietary LLMs.

Result: Significant variations in gender inclusivity were found among the models, highlighting existing biases.

Conclusion: The study underscores the need for improving LLMs' gender inclusivity and provides a benchmark for future research.
...
Method: Created SciVer with 3,000 expert-annotated examples from 1,113 papers, covering four reasoning types, and evaluated 21 state-of-the-art models.

Result: Found a significant performance gap between models and human experts, with limitations in open-source models identified.

Conclusion: SciVer provides insights to improve multimodal scientific reasoning in foundation models.
...
Method: DiscoSG-Refiner uses two small PLMs: one drafts a base graph, and another iteratively refines it, reducing overhead.

Result: DiscoSG-Refiner improves SPICE by ~30% over baselines and is 86x faster than GPT-4, enhancing downstream VLM tasks.

Conclusion: DiscoSG-Refiner offers an efficient, accurate solution for discourse-level scene graph parsing, with open-source code and data.
...
Method: Introduces WikiMixQA, a dataset of 1,000 MCQs based on tables and charts from 4,000 Wikipedia pages, testing 12 vision-language models.

Result: Proprietary models (e.g., GPT-4-o) achieve ~70% accuracy with direct context but drop significantly with retrieval; open-source models max at 27%.

Conclusion: WikiMixQA is a vital benchmark for advancing document understanding, revealing gaps in long-context, multi-modal reasoning capabilities.
...
<details>
  <summary>Details</summary>
Motivation: Manual MCQ creation is time-consuming and costly, and existing research lacks focus on non-English languages and quality assessment of generated MCQs.
...
Result: Current models produce MCQs comparable to human-authored ones but face issues with semantic clarity, answerability, and distractor quality.

Conclusion: Generative AI shows promise for MCQ automation in Portuguese, but improvements are needed in distractor design and semantic clarity.
...
Method: Proposes a workflow for dataset construction, S-CDI for layer identification, and RDS/GIC for neuron analysis.

Result: Identified optimal regret layers and neuron groups, revealing M-shaped decoupling patterns.

Conclusion: The methods improve regret analysis, aiding reliability and understanding of LLM cognition.
...
Result: Differences in intensifier interpretation arise from both literal meaning variations and differing weights on utterance cost, not just semantics or politeness norms.
...
Conclusion: Current LLMs need improvement in instruction-following and compositional generalization for better performance in ordered concept tasks.
...
<details>
  <summary>Details</summary>
Motivation: To address authorship attribution for Romanian texts using the ROST corpus and compare machine learning techniques.

Method: Evaluated SVM, LR, k-NN, DT, RF, and ANN using character n-gram features for classification.

Result: ANN achieved the highest performance, including perfect classification in some runs with 5-gram features.

Conclusion: Lightweight character n-gram approaches can achieve state-of-the-art accuracy, even in resource-constrained or under-studied languages.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the inconsistency and unreliability of LLM reasoning despite their broad capabilities.

Method: Uses Cohort-based Consistency Learning (CC-Learn), a reinforcement learning framework with a composite objective (cohort accuracy, retrieval bonus, rejection penalty) to enforce uniform reasoning.
...
<details>
  <summary>Details</summary>
Motivation: To challenge the assumption that reasoning traces are safe and highlight privacy risks in large reasoning models.
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of maintaining gender neutrality in grammatical gender languages during translation and avoid misgendering.

Method: Assessed 21 MT systems across three translation directions, categorizing observed gender-neutral strategies.
...
Conclusion: Current MT systems largely fail to handle gender ambiguity, though a few show promise with targeted strategies.
...
Method: GenRecal uses a Recalibrator to align feature representations between heterogeneous VLMs, facilitating cross-architecture knowledge distillation.

Result: GenRecal outperforms baseline and large-scale VLMs on multiple benchmarks.

Conclusion: GenRecal provides a general-purpose solution for efficient VLM deployment by overcoming architectural limitations.
...
<details>
  <summary>Details</summary>
Motivation: The rise of privately-tuned LLMs has degraded detection performance, necessitating a specialized solution.

Method: PhantomHunter uses family-aware learning to identify shared traits across LLM families.
...
<details>
  <summary>Details</summary>
Motivation: The need for reliable, explainable methods to distinguish AI-generated videos from authentic ones, addressing the limitations of binary classification approaches.
...
Result: The approach achieves strong generalization across various AI video generators, transforming detection into a transparent process.

Conclusion: Explainable detection methods like DAVID-XR1 promise trustworthy identification of AI-generated video content.
...
Method: Categorizes existing approaches by architectural design, input representations, and prediction strategies, with a focus on models tested on the ETH/UCY benchmark.

Result: Highlights recent advancements and categorizes methods, providing a structured overview of the field.

Conclusion: Identifies key challenges and outlines future research directions for improving multi-agent human trajectory prediction.
...
<details>
  <summary>Details</summary>
Motivation: The complexity of design demands requires generative tools, but understanding the differences between human and machine-generated forms is lacking.

Method: Built ArchForms-4000 dataset (2,000 human and 2,000 machine forms) and proposed ArchShapeNet, a 3D CNN with a saliency module for classification.
...
Method: Proposed an entropy-based adaptive frame buffering algorithm integrated with MobileNetV2 for real-time processing on devices like Raspberry Pi and NVIDIA Jetson Nano.
...
Method: Proposes Mask Separated Self-Attention, Variational Query Denoising, and a self-distillation strategy to enhance query quality and denoising efficiency.

Result: MonoVQD outperforms on KITTI and shows robust generalization on nuScenes.

Conclusion: MonoVQD advances DETR-based monocular 3D detection with its novel components, demonstrating broad applicability and performance gains.
...
<details>
  <summary>Details</summary>
Motivation: MLLMs underperform in chart-to-code generation due to the complexity of translating visual elements into structured code.

Method: Decomposes the task into visual understanding (via description and difference instructions) and code translation, followed by iterative refinement.
...
Conclusion: Embedding model pretraining is critical for FSIC success, and PictSure demonstrates its effectiveness.
...
<details>
  <summary>Details</summary>
Motivation: Kernel size selection in CNNs is often overlooked but impacts performance. The paper aims to provide a systematic, optimized approach.
...
Result: BKSEF improves accuracy by up to 3.1% and reduces FLOPs by 42.8% compared to traditional 3x3 kernels, validated on multiple datasets and real-world cases.

Conclusion: BKSEF offers a practical, theoretical framework for optimizing kernel size, enhancing CNN efficiency and performance in diverse applications.
...
<details>
  <summary>Details</summary>
Motivation: The challenge is to determine the minimal set of views for accurate 3D reconstruction, avoiding redundant viewpoints and computational overhead.

Method: UPNet predicts uncertainty maps from a single input image, using heuristics to select optimal viewpoints. Aggregated uncertainty maps suppress redundancy, and selected views train 3D neural rendering models.
...
Conclusion: UPNet offers an efficient, scalable solution for AVS, balancing accuracy and computational efficiency while generalizing well to new tasks.
...
<details>
  <summary>Details</summary>
Motivation: Improving alignment in T2I models to ensure they capture user intent while maintaining safety and fairness, inspired by DPO's success in LLMs.

Method: Proposes DPO-Kernels with Hybrid Loss, Kernelized Representations (RBF, Polynomial, Wavelet), and expanded Divergence Selection (Wasserstein, R'enyi). Introduces DETONATE benchmark and AQI measure.

Result: DPO-Kernels show strong generalization via HT-SR. DETONATE provides a large-scale dataset for evaluating social bias in T2I models.
...
Method: Focuses on mid-frequency reconstruction errors, excluding high and low frequencies, and uses structural similarity index scores to determine membership.

Result: FCRE method outperforms existing MIA methods on medical image datasets.

Conclusion: The FCRE method effectively mitigates the impact of inherent image difficulty, enhancing privacy risk quantification for medical image diffusion models.
...
<details>
  <summary>Details</summary>
Motivation: Improving jet tagging for new physics searches and precision measurements at the Large Hadron Collider.

Method: Uses simulated 2012 CMS Open Data to construct multi-channel jet-view images and evaluates ViT and hybrid models.

Result: ViT-based models outperform CNN baselines in F1-score, ROC-AUC, and accuracy.

Conclusion: ViTs are effective for jet classification, providing a framework for future deep learning research in this domain.
...
Method: Uses LRCN and Transformer architectures with RGB tactile images from GelSight to predict compliance metrics.

Result: Models show significant performance improvement; harder objects are more challenging to estimate.

Conclusion: The proposed models effectively improve compliance estimation, though object hardness affects accuracy.
...
Result: PALETTE with SynthMap+ outperforms SOTA on historical map benchmarks, especially for long and angled text. It processed 60,000+ maps, generating 100M+ labels.

Conclusion: PALETTE advances text extraction from historical maps, offering a scalable solution with synthetic training data and improved performance for complex text instances.
...
### [59] [Break Stylistic Sophon: Are We Really Meant to Confine the Imagination in Style Transfer?](https://arxiv.org/abs/2506.15033)
...
TL;DR: StyleWallfacer is a unified framework for style transfer, addressing traditional issues and unifying tasks. It uses semantic-based style injection, human feedback data augmentation, and a training-free triple diffusion process to achieve high-quality, artist-level results with text control and color editing.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in traditional style transfer methods and unify frameworks for diverse tasks, enabling artist-level results and text-driven stylization.

Method: 1. Semantic-based style injection using BLIP and CLIP to create a semantic gap for drift-free style knowledge injection. 2. Human feedback data augmentation for progressive learning. 3. Training-free triple diffusion process for feature manipulation in self-attention layers.

Result: High-quality image-driven style transfer, text-driven stylization, and image color editing with preserved content.

Conclusion: StyleWallfacer revolutionizes style transfer by unifying tasks, achieving artist-level results, and introducing novel capabilities like color editing.
...
### [60] [Enhancing Vector Quantization with Distributional Matching: A Theoretical and Empirical Study](https://arxiv.org/abs/2506.15078)
...
TL;DR: The paper addresses training instability and codebook collapse in vector quantization for autoregressive models by using Wasserstein distance to align feature and code vector distributions, achieving high codebook utilization and reduced quantization error.


<details>
  <summary>Details</summary>
Motivation: Existing vector quantization methods suffer from training instability and codebook collapse due to distribution mismatches between features and code vectors, leading to unrepresentative code vectors and data loss.
...
Conclusion: The proposed method effectively mitigates training instability and codebook collapse, improving the performance of vector quantization in autoregressive models.
...
### [61] [SynPo: Boosting Training-Free Few-Shot Medical Segmentation via High-Quality Negative Prompts](https://arxiv.org/abs/2506.15153)
...
Conclusion: SynPo effectively addresses the limitations of existing methods by improving negative prompt quality, achieving competitive results without training.
...
### [62] [Enhancing point cloud analysis via neighbor aggregation correction based on cross-stage structure correlation](https://arxiv.org/abs/2506.15160)
...
Method: The PDSA module leverages high-dimensional correlations to correct feature distribution during aggregation, using a lightweight cross-stage structural descriptor and a key point mechanism to optimize efficiency.
...
Conclusion: PDSA effectively addresses limitations of local coordinates and geometric structure encoding, offering a robust and efficient solution for point cloud analysis.
...
### [63] [Echo-DND: A dual noise diffusion model for robust and precise left ventricle segmentation in echocardiography](https://arxiv.org/abs/2506.15166)
...
### [64] [ReSeDis: A Dataset for Referring-based Object Search across Large-Scale Image Collections](https://arxiv.org/abs/2506.15180)
...
Method: Introduces the ReSeDis task, combining retrieval and grounding, and provides a benchmark with unique object-description mappings.
...
### [65] [Conquering the Retina: Bringing Visual in-Context Learning to OCT](https://arxiv.org/abs/2506.15200)
...
<details>
  <summary>Details</summary>
Motivation: Specialized medical image analysis models are limited to predefined tasks, requiring expertise and resources, while generalist models offer flexibility for practitioners.

Method: The study trains generalist models using VICL for retinal OCT, allowing task generalization based on few examples at inference time, and proposes a tailored evaluation protocol.

Result: A state-of-the-art medical VICL approach is evaluated on multiple retinal OCT datasets, establishing a baseline for in-context learning in OCT.

Conclusion: The work highlights the potential and limitations of VICL for OCT, encouraging further research and practical adoption by releasing open code.
...
### [66] [Privacy-Shielded Image Compression: Defending Against Exploitation from Vision-Language Pretrained Models](https://arxiv.org/abs/2506.15201)
*Xuelin Shen,Jiayin Xu,Kangsheng Yin,Wenhan Yang*

Main category: cs.CV

TL;DR: The paper proposes Privacy-Shielded Image Compression (PSIC) to protect images from exploitation by vision-language models, offering flexible decoding options while maintaining compression functionality.


<details>
  <summary>Details</summary>
Motivation: To safeguard user privacy by preventing image exploitation by advanced vision-language models, addressing the limitations of current defenses.

Method: Introduces PSIC with a Conditional Latent Trigger Generation (CLTG) module and Uncertainty-Aware Encryption-Oriented (UAEO) optimization, enabling adaptive multi-objective optimization for balanced encryption and quality.

Result: Demonstrates effectiveness across multiple tasks, showing improved encryption and perceptual quality without compromising compression.

Conclusion: PSIC is a versatile, plug-and-play solution for privacy protection in image compression, compatible with existing models.
...
### [67] [DM-FNet: Unified multimodal medical image fusion via diffusion process-trained encoder-decoder](https://arxiv.org/abs/2506.15218)
*Dan He,Weisheng Li,Guofen Wang,Yuping Huang,Shiqiang Liu*

Main category: cs.CV

TL;DR: The paper proposes DM-FNet, a two-stage diffusion model-based network for multimodal medical image fusion, addressing limitations in feature capture and cross-modal interaction to improve fused image quality.
...
Conclusion: DM-FNet enhances MMIF quality by leveraging diffusion models and adaptive fusion, validated by superior experimental results.
...
### [68] [video-SALMONN 2: Captioning-Enhanced Audio-Visual Large Language Models](https://arxiv.org/abs/2506.15220)
...
<details>
  <summary>Details</summary>
Motivation: Enhancing video understanding by generating detailed and accurate descriptions in natural language.
...
Conclusion: Video-SALMONN 2 achieves state-of-the-art performance in video captioning and competitive results in video QA.
...
### [69] [Convolutional Feature Enhancement and Attention Fusion BiFPN for Ship Detection in SAR Images](https://arxiv.org/abs/2506.15231)
...
Conclusion: C-AFBiFPN effectively addresses SAR ship detection challenges, enhancing performance in complex scenarios.
...
### [70] [RA-NeRF: Robust Neural Radiance Field Reconstruction with Accurate Camera Pose Estimation under Complex Trajectories](https://arxiv.org/abs/2506.15242)
...
### [71] [Retrospective Memory for Camouflaged Object Detection](https://arxiv.org/abs/2506.15244)
*Chenxi Zhang,Jiayun Wu,Qing Zhang,Yazhe Zhai,Youwei Pang*

Main category: cs.CV

TL;DR: Proposes RetroMem, a recall-augmented COD architecture integrating historical knowledge to improve camouflage object detection.


<details>
  <summary>Details</summary>
Motivation: Existing COD methods lack mechanisms for historical context, limiting effectiveness in complex scenes.

Method: Two-stage training: learning stage with DMA for multi-scale info, recall stage with DMM and IPR for dynamic memory usage.

Result: RetroMem outperforms state-of-the-art methods on multiple datasets.

Conclusion: RetroMem enhances COD by dynamically leveraging historical knowledge and multi-scale information.
...
### [72] [Domain Adaptation for Image Classification of Defects in Semiconductor Manufacturing](https://arxiv.org/abs/2506.15260)
*Adrian Poniatowski,Natalie Gentner,Manuel Barusco,Davide Dalle Pezze,Samuele Salti,Gian Antonio Susto*

Main category: cs.CV

TL;DR: The paper explores Domain Adaptation (DA) techniques in the semiconductor sector, proposing the DBACS model to improve defect classification with reduced manual effort.


<details>
  <summary>Details</summary>
Motivation: High demand and competition in semiconductors require efficient quality control. DA minimizes re-labeling/re-training costs while leveraging deep learning success.
...
Result: Validated on real-world data, DBACS advances DA techniques for semiconductor applications, proving efficacy in reducing manual effort.

Conclusion: DBACS enhances DA robustness and scalability, offering a practical solution for semiconductor defect classification.
...
### [73] [MSNeRV: Neural Video Representation with Multi-Scale Feature Fusion](https://arxiv.org/abs/2506.15276)
...
Conclusion: MSNeRV addresses limitations of INR-based methods and achieves state-of-the-art performance in video compression.
...
### [74] [BCRNet: Enhancing Landmark Detection in Laparoscopic Liver Surgery via Bezier Curve Refinement](https://arxiv.org/abs/2506.15279)
...
### [75] [AI-driven visual monitoring of industrial assembly tasks](https://arxiv.org/abs/2506.15285)
...
Conclusion: ViMAT demonstrates robust performance in real-world industrial assembly monitoring, offering a marker-free, flexible solution.
...
### [76] [MEGC2025: Micro-Expression Grand Challenge on Spot Then Recognize and Visual Question Answering](https://arxiv.org/abs/2506.15298)
*Xinqi Fan,Jingting Li,John See,Moi Hoon Yap,Wen-Huang Cheng,Xiaobai Li,Xiaopeng Hong,Su-Jing Wang,Adrian K. Davision*

Main category: cs.CV

TL;DR: The paper discusses advancements in facial micro-expression (ME) analysis, introducing two new tasks (ME-STR and ME-VQA) for the MEGC 2025 challenge, leveraging multimodal models for improved performance.


<details>
  <summary>Details</summary>
Motivation: Current ME analysis methods treat spotting and recognition as separate tasks, which is suboptimal for realistic, long-duration videos. The rise of multimodal models offers new opportunities for enhanced ME analysis.

Method: The paper proposes two tasks: ME-STR (unified spotting and recognition) and ME-VQA (visual question answering using MLLMs/LVLMs).

Result: The MEGC 2025 challenge will evaluate algorithms on these tasks, with results submitted to a leaderboard.

Conclusion: The integration of multimodal models and unified tasks aims to advance ME analysis, addressing limitations of conventional approaches.
...
### [77] [MapFM: Foundation Model-Driven HD Mapping with Multi-Task Contextual Learning](https://arxiv.org/abs/2506.15313)
...
Method: MapFM integrates a foundation model for encoding camera images and auxiliary prediction heads for semantic segmentation in BEV, using multi-task learning.

Result: The approach enhances feature representation and scene understanding, leading to higher accuracy and quality in predicted vectorized HD maps.

Conclusion: MapFM demonstrates improved performance in HD map generation, with its source code made publicly available for further research.
...
### [78] [OpenPath: Open-Set Active Learning for Pathology Image Classification via Pre-trained Vision-Language Models](https://arxiv.org/abs/2506.15318)
*Lanfeng Zhong,Xin Liao,Shichuan Zhang,Shaoting Zhang,Guotai Wang*

Main category: cs.CV

TL;DR: OpenPath introduces an open-set active learning method for pathology image classification, leveraging a pre-trained VLM to efficiently select informative in-distribution samples while avoiding OOD data.


<details>
  <summary>Details</summary>
Motivation: Traditional AL methods assume closed-set scenarios and waste labeling costs in open-set environments with OOD data. OpenPath addresses this inefficiency.

Method: Uses task-specific prompts for initial query and Diverse Informative ID Sampling (DIS) for subsequent queries, combining prototype-based selection and entropy-guided sampling.

Result: Outperforms state-of-the-art open-set AL methods on two pathology datasets, enhancing model performance with high sample purity.

Conclusion: OpenPath effectively reduces labeling costs and improves efficiency in real-world clinical settings with OOD data.
...
### [79] [Open-World Object Counting in Videos](https://arxiv.org/abs/2506.15368)
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of counting unique object instances in videos, especially in crowded scenes with occlusions and similar objects.
...
### [80] [Unsupervised Pelage Pattern Unwrapping for Animal Re-identification](https://arxiv.org/abs/2506.15369)
...
Conclusion: The self-supervised framework enhances robustness in feature matching across diverse poses and viewing angles.
...
### [81] [When Model Knowledge meets Diffusion Model: Diffusion-assisted Data-free Image Synthesis with Alignment of Domain and Class](https://arxiv.org/abs/2506.15381)
...
<details>
  <summary>Details</summary>
Motivation: Open-source pre-trained models lose utility without access to their training data. Existing DFIS methods fail to accurately replicate the training data distribution due to lack of natural image priors.

Method: DDIS uses a text-to-image diffusion model as an image prior, introduces Domain Alignment Guidance (DAG) for domain alignment, and optimizes a Class Alignment Token (CAT) for class-specific attributes.

Result: DDIS outperforms prior DFIS methods on PACS and ImageNet, generating samples that better reflect the training data distribution and achieving state-of-the-art performance.

Conclusion: DDIS effectively addresses the limitations of DFIS by integrating diffusion models, improving synthetic image quality and alignment with the original data distribution.
...
### [82] [NERO: Explainable Out-of-Distribution Detection with Neuron-level Relevance](https://arxiv.org/abs/2506.15404)
*Anju Chhetri,Jari Korhonen,Prashnna Gyawali,Binod Bhattarai*

Main category: cs.CV

TL;DR: The paper introduces NERO, a novel OOD scoring mechanism for medical imaging that uses neuron-level relevance to improve OOD detection and reliability.


<details>
  <summary>Details</summary>
Motivation: Reliability in deep learning for medical imaging is critical, and current OOD detection methods may not fully capture OOD diversity.

Method: NERO clusters neuron-level relevance for ID classes, uses a relevance distance metric, and incorporates scaled relevance and feature norms.

Result: NERO outperforms state-of-the-art OOD detection methods on gastrointestinal imaging benchmarks.

Conclusion: NERO enhances OOD detection and reliability in medical imaging, offering explainable results.
...
### [83] [Hunyuan3D 2.1: From Images to High-Fidelity 3D Assets with Production-Ready PBR Material](https://arxiv.org/abs/2506.15442)
...
Result: Participants will gain the ability to develop or finetune 3D generative models for gaming, VR, and design.

Conclusion: The tutorial aims to democratize 3D AIGC by simplifying the process of creating high-resolution 3D assets.
...
### [84] [Multimodal Large Language Models for Medical Report Generation via Customized Prompt Tuning](https://arxiv.org/abs/2506.15477)
...
Method: Uses a frozen LLM with a learnable visual encoder and dynamic prompt customization via conditional affine transformations.
...
### [85] [GenHOI: Generalizing Text-driven 4D Human-Object Interaction Synthesis for Unseen Objects](https://arxiv.org/abs/2506.15483)
...
Result: State-of-the-art performance on OMOMO and 3D-FUTURE datasets, showcasing strong generalization to unseen objects and high-fidelity 4D HOI generation.

Conclusion: GenHOI effectively addresses the limitations of 4D HOI datasets and advances the synthesis of realistic human-object interactions.
...
### [86] [NTIRE 2025 Image Shadow Removal Challenge Report](https://arxiv.org/abs/2506.15524)
...
Result: 17 teams submitted solutions, tested on diverse scenarios with self- and cast-shadows.

Conclusion: The challenge highlights progress in shadow removal, with diverse solutions evaluated rigorously.
...
### [87] [SemIRNet: A Semantic Irony Recognition Network for Multimodal Sarcasm Detection](https://arxiv.org/abs/2506.14791)
*Jingxuan Zhou,Yuehao Wu,Yibo Zhang,Yeyubei Zhang,Yunchong Liu,Bolin Huang,Chunhong Yuan*

Main category: cs.CV

TL;DR: The paper introduces SemIRNet, a model for multimodal irony detection, leveraging ConceptNet, cross-modal semantic similarity detection, and contrastive learning to improve accuracy and F1 scores.


<details>
  <summary>Details</summary>
Motivation: The difficulty in identifying graphical implicit correlations in multimodal irony detection tasks motivates the development of a more accurate model.

Method: SemIRNet uses ConceptNet for common-sense reasoning, cross-modal semantic similarity detection at word and sample levels, and contrastive learning for feature optimization.

Result: The model achieves 88.87% accuracy and 86.33% F1 score, outperforming existing methods by 1.64% and 2.88%, respectively.
...
### [88] [CLAIM: Clinically-Guided LGE Augmentation for Realistic and Diverse Myocardial Scar Synthesis and Segmentation](https://arxiv.org/abs/2506.15549)
...
Method: CLAIM uses the SMILE module, a diffusion-based generator conditioned on the AHA 17-segment model, and joint training of the segmentation network and generator.

Result: CLAIM produces anatomically coherent scar patterns and achieves higher Dice similarity with real scar distributions than baselines.
...
### [89] [RaCalNet: Radar Calibration Network for Sparse-Supervised Metric Depth Estimation](https://arxiv.org/abs/2506.15560)
...
<details>
  <summary>Details</summary>
Motivation: Current methods for dense metric depth estimation with radar rely on costly and data-intensive dense LiDAR supervision. RaCalNet aims to reduce this dependency.
...
Result: RaCalNet outperforms dense-supervised methods, improving structural consistency and detail preservation, with RMSE reductions of 35.30% and 34.89%.
...
### [90] [Argus Inspection: Do Multimodal Large Language Models Possess the Eye of Panoptes?](https://arxiv.org/abs/2506.14805)
...
Method: Develop Argus Inspection benchmark and Eye of Panoptes framework with a binary parametric Sigmoid metric for holistic evaluation.

Result: Experiments on 26 MLLMs show the highest performance in visual fine-grained reasoning is only 0.46.

Conclusion: The study provides insights for refining MLLMs, highlighting their potential for further enhancement.
...
### [91] [Control and Realism: Best of Both Worlds in Layout-to-Image without Training](https://arxiv.org/abs/2506.15563)
...
### [92] [Show-o2: Improved Native Unified Multimodal Models](https://arxiv.org/abs/2506.15564)
*Jinheng Xie,Zhenheng Yang,Mike Zheng Shou*

Main category: cs.CV

TL;DR: Show-o2 introduces unified multimodal models using autoregressive modeling and flow matching for versatile understanding and generation across text, images, and videos.


<details>
  <summary>Details</summary>
Motivation: To create scalable and effective multimodal models for diverse tasks.

Method: Leverages a 3D causal variational autoencoder, dual-path fusion, autoregressive modeling, and flow matching in a two-stage training process.

Result: Show-o2 excels in multimodal understanding and generation tasks.

Conclusion: The approach is versatile and scalable, with released code and models.
...
### [93] [Baltimore Atlas: FreqWeaver Adapter for Semi-supervised Ultra-high Spatial Resolution Land Cover Classification](https://arxiv.org/abs/2506.15565)
...
Method: Proposes a parameter-efficient semi-supervised segmentation framework for 0.3 m resolution imagery, integrating SAM2 knowledge and a FreqWeaver Adapter.

Result: Achieves 1.78% improvement over parameter-efficient tuning and 3.44% gain over state-of-the-art high-resolution methods.

Conclusion: The framework effectively leverages unlabeled data and maintains low parameter overhead for robust segmentation.
...
### [94] [A Unified Graph-based Framework for Scalable 3D Tree Reconstruction and Non-Destructive Biomass Estimation from Point Clouds](https://arxiv.org/abs/2506.15577)
*Di Wang,Shi Li*

Main category: cs.CV

TL;DR: A novel graph-based framework for estimating forest above-ground biomass (AGB) using 3D tree reconstruction, reducing reliance on high-quality data and pre-processing steps.
...
Conclusion: The framework offers a scalable, practical solution for large-scale AGB estimation, reducing TLS dependency and enabling broader applications in forestry and climate research.
...
### [95] [One-Step Diffusion for Detail-Rich and Temporally Consistent Video Super-Resolution](https://arxiv.org/abs/2506.15591)
*Yujing Sun,Lingchen Sun,Shuaizheng Liu,Rongyuan Wu,Zhengqiang Zhang,Lei Zhang*

Main category: cs.CV

TL;DR: Proposes Dual LoRA Learning (DLoRAL) for video super-resolution, balancing spatial detail and temporal consistency using stable diffusion.


<details>
  <summary>Details</summary>
Motivation: Existing methods compromise spatial details for temporal coherence in Real-VSR. The challenge is to enhance details while maintaining consistency.

Method: Uses Cross-Frame Retrieval (CFR) and Consistency-LoRA (C-LoRA) for temporal consistency, then Detail-LoRA (D-LoRA) for spatial enhancement, iteratively optimizing both.

Result: DLoRAL achieves high-quality, temporally consistent video restoration in one diffusion step, outperforming in accuracy and speed.

Conclusion: DLoRAL effectively balances detail enhancement and temporal consistency, offering efficient Real-VSR.
...
### [96] [Mono-Modalizing Extremely Heterogeneous Multi-Modal Medical Image Registration](https://arxiv.org/abs/2506.15596)
...
Method: Proposes M2M-Reg, training multi-modal DIR models using mono-modal similarity, and GradCyCon for regularization. Extends to semi-supervised learning without ground-truth.
...
### [97] [BoxFusion: Reconstruction-Free Open-Vocabulary 3D Object Detection via Real-Time Multi-View Box Fusion](https://arxiv.org/abs/2506.15610)
...
<details>
  <summary>Details</summary>
Motivation: Address computational overhead and memory constraints of dense point cloud reconstruction in existing methods for real-time deployment.

Method: Uses Cubify Anything for single-view 3D detection and CLIP for semantics, with multi-view fusion via association and optimization modules.
...
Conclusion: The reconstruction-free paradigm offers efficient, scalable, and generalizable 3D object detection for real-world applications.
...
### [98] [HOIDiNi: Human-Object Interaction through Diffusion Noise Optimization](https://arxiv.org/abs/2506.15625)
...
Result: Outperforms prior works in contact accuracy, physical validity, and quality on the GRAB dataset.

Conclusion: HOIDiNi enables complex, controllable HOI synthesis driven by text prompts.
...
### [99] [FindingDory: A Benchmark to Evaluate Memory in Embodied Agents](https://arxiv.org/abs/2506.15635)
...
<details>
  <summary>Details</summary>
Motivation: Deploying large vision-language models (VLMs) in robotics is limited by their inability to efficiently process long-term experience (e.g., vast image collections) and perform memory-intensive tasks like object manipulation and navigation.

Method: The study introduces a benchmark with 60 tasks in the Habitat simulator, requiring sustained engagement and contextual awareness, and integrates state-of-the-art VLMs with navigation policies for evaluation.

Result: Baseline models combining VLMs and navigation policies are assessed, revealing areas needing improvement in memory and reasoning for embodied tasks.

Conclusion: The benchmark enables scalable evaluation of memory and reasoning in embodied agents, highlighting the need for better memory integration in VLMs for real-world robotics.
...
### [100] [Demystifying the Visual Quality Paradox in Multimodal Large Language Models](https://arxiv.org/abs/2506.15645)
*Shuo Xing,Lanqing Guo,Hongyuan Hua,Seoyoung Lee,Peiran Li,Yufei Wang,Zhangyang Wang,Zhengzhong Tu*

Main category: cs.CV

TL;DR: MLLMs perform better with degraded images, contrary to human perception. VQ-TTT, a lightweight adaptation module, improves accuracy by aligning image quality with model preferences.
...
Method: Introduces VQ-TTT, a module that dynamically adjusts image quality via a learnable kernel and fine-tunes shallow vision-encoder layers using LoRA.

Result: VQ-TTT improves average accuracy across MLLMs and datasets without external models or extra data.

Conclusion: Adaptive image quality, not universal cleanliness, is key for MLLMs, redefining what constitutes 'better' visual inputs.
...
### [101] [Dual-Stage Value-Guided Inference with Margin-Based Reward Adjustment for Fast and Faithful VLM Captioning](https://arxiv.org/abs/2506.15649)
...
### [102] [UniRelight: Learning Joint Decomposition and Synthesis for Video Relighting](https://arxiv.org/abs/2506.15673)
...
<details>
  <summary>Details</summary>
Motivation: Overcome limitations of existing relighting methods, such as data scarcity and error accumulation, to achieve better scene understanding and lighting effects.
...
Result: Outperforms prior methods in visual fidelity and temporal consistency, with strong generalization across domains.

Conclusion: The proposed approach effectively addresses relighting challenges, offering high-quality results and broad applicability.
...
### [103] [Sekai: A Video Dataset towards World Exploration](https://arxiv.org/abs/2506.15675)
...
TL;DR: The paper introduces Sekai, a high-quality first-person video dataset for world exploration, addressing limitations of existing datasets. It includes 5,000+ hours of videos from 100+ countries, with rich annotations. A toolbox for processing and an interactive model (YUME) are also presented.


<details>
  <summary>Details</summary>
Motivation: Existing video generation datasets lack diversity, duration, and annotations for world exploration, limiting their utility.

Method: The authors create Sekai, a dataset with 5,000+ hours of first-person videos from 100+ countries, annotated with location, scene, weather, etc. They develop a toolbox for processing and train an interactive model (YUME).

Result: Experiments confirm the dataset's quality, and YUME demonstrates its potential for interactive world exploration.

Conclusion: Sekai is a valuable resource for video generation and world exploration, with promising applications.
...
### [104] [Evolutionary Caching to Accelerate Your Off-the-Shelf Diffusion Model](https://arxiv.org/abs/2506.15682)
...
Result: ECAD achieves better quality-latency trade-offs, outperforming prior methods (e.g., 4.47 FID improvement on PixArt-alpha).

Conclusion: ECAD is scalable, generalizable, and effective for accelerating diffusion models.
...
### [105] [ETS: Open Vocabulary Electroencephalography-To-Text Decoding and Sentiment Classification](https://arxiv.org/abs/2506.14783)
*Mohamed Masry,Mohamed Amen,Mohamed Elzyat,Mohamed Hamed,Norhan Magdy,Maram Khaled*

Main category: cs.LG

TL;DR: The paper proposes ETS, a framework combining EEG and eye-tracking for open-vocabulary EEG-to-text decoding and sentiment classification, outperforming baselines.
...
### [106] [Assembly of Experts: Linear-time construction of the Chimera LLM variants with emergent and adaptable behaviors](https://arxiv.org/abs/2506.14794)
...
<details>
  <summary>Details</summary>
Motivation: To address the inefficiency and high computational cost of pretraining large language models (LLMs) by leveraging existing pretrained models more effectively.

Method: Develops the AoE method, which interpolates individual weight tensors from parent models to create child variants, enabling gradual or sharp trait transitions.

Result: Demonstrates the effectiveness of AoE with the DeepSeek R1T 'Chimera' model, which combines traits of parent models, achieving comparable intelligence with fewer tokens and faster speed.

Conclusion: AoE enables efficient creation of functional child models without fine-tuning, offering a practical approach to model development and space exploration.
...
### [107] [Revisiting Reinforcement Learning for LLM Reasoning from A Cross-Domain Perspective](https://arxiv.org/abs/2506.14965)
...
TL;DR: The paper introduces Guru, a curated RL reasoning corpus to improve LLM reasoning across diverse domains, revealing nuanced RL benefits and achieving SOTA performance with Guru-7B and Guru-32B models.


<details>
  <summary>Details</summary>
Motivation: To address the lack of reliable, scalable RL reward signals for diverse reasoning domains and expand RL's applicability beyond math and code.

Method: Developed Guru, a corpus of 92K verifiable examples across six reasoning domains, using domain-specific reward design, deduplication, and filtering. Evaluated RL training effects across domains.

Result: Showed significant variation in RL benefits: domains with pretraining exposure (Math, Code, Science) benefit from cross-domain RL, while others (Logic, Simulation, Tabular) require in-domain training. Guru-7B and Guru-32B achieved SOTA performance.

Conclusion: RL can facilitate genuine skill acquisition in LLMs, especially for less common reasoning domains. The released resources aim to advance general-purpose reasoning.
...
### [108] [Optimal Embedding Learning Rate in LLMs: The Effect of Vocabulary Size](https://arxiv.org/abs/2506.15025)
...
### [109] [When and How Unlabeled Data Provably Improve In-Context Learning](https://arxiv.org/abs/2506.15329)
...
<details>
  <summary>Details</summary>
Motivation: To understand why ICL remains effective despite imperfect labels and to theoretically analyze the role of model architecture in exploiting unlabeled data.
...
Result: Multilayer transformers implicitly construct polynomial estimators, enabling exponential gains with depth, and outperform single-pass inference in semi-supervised tabular learning.

Conclusion: Depth or looping in transformers enhances semi-supervised learning, with practical improvements demonstrated on real-world datasets.
...
### [110] [Capturing Polysemanticity with PRISM: A Multi-Concept Feature Description Framework](https://arxiv.org/abs/2506.15538)
*Laura Kopf,Nils Feldhus,Kirill Bykov,Philine Lou Bommer,Anna Hedström,Marina M. -C. Höhne,Oliver Eberle*

Main category: cs.LG

TL;DR: PRISM is a new framework for interpreting neural network features, addressing limitations of current methods by handling polysemanticity and providing nuanced descriptions.


<details>
  <summary>Details</summary>
Motivation: Current feature description methods lack robustness and assume monosemanticity, limiting their ability to capture the full complexity of neural network features.

Method: PRISM (Polysemantic FeatuRe Identification and Scoring Method) is introduced to provide nuanced descriptions for both polysemantic and monosemantic features.

Result: PRISM outperforms existing methods in accuracy and faithfulness of feature descriptions, improving description and polysemanticity scores.

Conclusion: PRISM enhances interpretability by better capturing the complexity of neural network features, addressing key challenges in automated interpretability research.
...
Result: LoX reduces attack success rates by 11-54% against benign/malicious fine-tuning, preserving task adaptability.

Conclusion: LoX effectively enhances LLM safety robustness by moving parameters to a flatter, less perturbation-sensitive zone.
...
### [112] [AutoRule: Reasoning Chain-of-thought Extracted Rule-based Rewards Improve Preference Learning](https://arxiv.org/abs/2506.15651)
...
Method: AutoRule uses a reasoning model to interpret preferences, extracts candidate rules, and synthesizes them into a unified set. It employs rule-based rewards alongside learned rewards for policy optimization.

Result: AutoRule improves win rates by 28.6% on AlpacaEval2.0 and 6.1% on MT-Bench, with reduced reward hacking and good agreement with dataset preferences.
...
<details>
  <summary>Details</summary>
Motivation: Existing multimodal approaches neglect visual data in time series, and models struggle to capture physical information like geospatial context in satellite imagery.
...
Conclusion: PIPE effectively bridges the gap in multimodal forecasting by leveraging physical information, setting new benchmarks in the field.
...
### [114] [Dense SAE Latents Are Features, Not Bugs](https://arxiv.org/abs/2506.15679)
*Xiaoqing Sun,Alessandro Stolfo,Joshua Engels,Ben Wu,Senthooran Rajamanoharan,Mrinmaya Sachan,Max Tegmark*

Main category: cs.LG

TL;DR: SAEs produce dense latents that are meaningful, not noise, serving functional roles in language models.


<details>
  <summary>Details</summary>
Motivation: To investigate the persistence and function of dense latents in SAEs, which are often dismissed as artifacts.
...
Result: Dense latents form antipodal pairs, represent meaningful functions, and evolve across layers (structural → semantic → output-oriented).

Conclusion: Dense latents are intrinsic to language models and serve functional purposes, not just training noise.
...
### [115] [Reinforcing VLMs to Use Tools for Detailed Visual Reasoning Under Resource Constraints](https://arxiv.org/abs/2506.14821)
*Sunil Kumar,Bowen Zhao,Leo Dirac,Paulina Varshavskaya*

Main category: cs.LG

TL;DR: Smaller-scale VLMs trained with GRPO and external tools like zoom outperform baselines in visual reasoning tasks.
...
Method: Training smaller models using GRPO, a simple reward structure, simplified tool-calling, and a data mix favoring visually difficult examples.

Result: Improved performance on VQA tasks due to detailed visual information from external tools.

Conclusion: GRPO and tool integration enhance VLM performance in visual reasoning.
...
### [116] [CACTUS as a Reliable Tool for Early Classification of Age-related Macular Degeneration](https://arxiv.org/abs/2506.14843)
...
TL;DR: CACTUS improves AMD classification by addressing data limitations and enhancing explainability in ML models.


<details>
  <summary>Details</summary>
Motivation: Healthcare data is often incomplete, and ML models lack transparency, especially for AMD diagnosis, which requires early detection.

Method: Developed CACTUS, a tool combining genetic, dietary, clinical, and demographic factors for AMD classification, with explainability features.
...
Conclusion: CACTUS enhances decision-making and reduces bias, offering a practical solution for AMD diagnosis and clinician feedback.
...
### [117] [Pixel-level Certified Explanations via Randomized Smoothing](https://arxiv.org/abs/2506.15499)
...
Result: The proposed method certifies robustness for 12 attribution methods across 5 ImageNet models, showing robust, interpretable, and faithful attributions.

Conclusion: The certification framework enables reliable use of attribution methods in downstream tasks by ensuring robustness and faithfulness.
...
### [118] [Detecting Narrative Shifts through Persistent Structures: A Topological Analysis of Media Discourse](https://arxiv.org/abs/2506.14836)
...
<details>
  <summary>Details</summary>
Motivation: To identify and analyze fundamental shifts in public discourse caused by major geopolitical and social events without prior knowledge of specific events.

Method: Constructs daily co-occurrence graphs of noun phrases from news articles, embeds them, and transforms into persistence diagrams using Vietoris-Rips filtration. Computes Wasserstein distances and persistence entropies to measure semantic disruption and narrative volatility.

Result: Major events correlate with spikes in H0 (connected components) and H1 (loops), indicating narrative reorganization. Cross-correlation shows H0 changes precede H1 shifts, except during the Russian invasion of Ukraine where H1 leads. Persistence entropy distinguishes focused vs. diffuse narratives.

Conclusion: Persistent homology provides an unsupervised, principled method for detecting real-time semantic restructuring in public discourse during crises, advancing computational social science.
...
### [119] [Identifying economic narratives in large text corpora -- An integrated approach using Large Language Models](https://arxiv.org/abs/2506.15041)
...
Method: Analyzes GPT-4o's performance on extracting narratives from inflation-related articles, comparing it to expert annotations.

Result: GPT-4o extracts valid economic narratives but underperforms experts on complex cases.
...
### [120] [Factorized RVQ-GAN For Disentangled Speech Tokenization](https://arxiv.org/abs/2506.15456)
...
TL;DR: The paper analyzes bugs in DataViz libraries, identifying symptoms, root causes, and a taxonomy, while exploring VLMs for bug detection.
...
Method: Analysis of 564 bugs from five popular DataViz libraries, including symptom and root cause categorization, and testing VLMs for bug detection.

Result: Incorrect plots are common, with graphic computation errors as the main cause. VLMs' detection effectiveness ranges from 29% to 57%.

Conclusion: The study highlights the need for better automated testing in DataViz libraries and suggests VLMs as a partial solution, though with limitations.
...
### [122] [Hypothesis Testing for Quantifying LLM-Human Misalignment in Multiple Choice Settings](https://arxiv.org/abs/2506.14997)
*Harbin Hong,Sebastian Caldas,Liu Leqi*

Main category: cs.CY

TL;DR: A framework to assess LLM-human behavior misalignment in surveys shows popular models may not simulate human opinions well, especially for contentious topics.


<details>
  <summary>Details</summary>
Motivation: To evaluate how well LLMs replicate human behavior in social science research, given their increasing use.
...
Conclusion: Highlights misalignment issues, urging better practices for using LLMs in social science beyond naive simulations.
...
### [123] [Cost-Efficient Serving of LLM Agents via Test-Time Plan Caching](https://arxiv.org/abs/2506.14852)
...
Method: Extracts, stores, and adapts plan templates from completed executions, using keyword matching and lightweight models for adaptation.
...
### [124] [Embodied Web Agents: Bridging Physical-Digital Realms for Integrated Agent Intelligence](https://arxiv.org/abs/2506.15677)
*Yining Hong,Rui Sun,Bingxuan Li,Xingcheng Yao,Maxine Wu,Alexander Chien,Da Yin,Ying Nian Wu,Zhecan James Wang,Kai-Wei Chang*

Main category: cs.AI

TL;DR: The paper introduces Embodied Web Agents, a paradigm integrating physical embodiment and web-scale reasoning for AI agents, addressing tasks requiring both.
...
Method: Developed a unified simulation platform (Embodied Web Agents task environments) and benchmark for tasks like cooking, navigation, and shopping, requiring cross-domain reasoning.

Result: Reveals performance gaps between state-of-the-art AI systems and humans, highlighting challenges and opportunities.
...
### [125] [Empirical Studies of Large Scale Environment Scanning by Consumer Electronics](https://arxiv.org/abs/2506.14771)
*Mengyuan Wang,Yang Liu,Haopeng Wang,Haiwei Dong,Abdulmotaleb El Saddik*

Main category: eess.IV

TL;DR: Evaluation of Matterport Pro3 for large-scale 3D scanning shows its cost-effectiveness and superior performance over iPhone, with higher point density and alignment accuracy.


<details>
  <summary>Details</summary>
Motivation: Assess the effectiveness and limitations of the Matterport Pro3 for large-scale environment reconstruction, comparing it with another consumer-grade device (iPhone).

Method: Conducted detailed scanning (1,099 points) of a six-floor building (17,567 sqm), analyzed performance, and proposed solutions for encountered challenges.

Result: Pro3 outperforms iPhone with 1,877,324 points vs. 506,961, RMSE of 0.0118m, and C2C error of 0.0408m (std: 0.0715m).

Conclusion: Pro3 is suitable for large-scale applications due to high-quality 3D models, leveraging LiDAR and advanced alignment.
...
### [126] [Deploying and Evaluating Multiple Deep Learning Models on Edge Devices for Diabetic Retinopathy Detection](https://arxiv.org/abs/2506.14834)
*Akwasi Asare,Dennis Agyemanh Nana Gookyi,Derrick Boateng,Fortunatus Aabangbio Wulnye*

Main category: eess.IV

TL;DR: A study introduces edge AI for real-time Diabetic Retinopathy detection using optimized deep learning models, achieving high accuracy and efficiency on edge devices.


<details>
  <summary>Details</summary>
Motivation: Traditional DR diagnosis is time-consuming and resource-intensive, necessitating a scalable, cost-effective solution for early detection, especially in remote settings.

Method: Multiple CNNs (MobileNet, ShuffleNet, SqueezeNet, custom DNN) were trained on a curated dataset, optimized for edge deployment via TensorFlowLite and 8-bit quantization.

Result: MobileNet achieved 96.45% accuracy; SqueezeNet showed 17 ms latency and 176 KB size. Other models balanced accuracy and resource efficiency for lower-end devices.

Conclusion: Edge AI offers a scalable, timely, and accurate solution for DR detection, particularly beneficial in resource-constrained healthcare environments.
...
### [127] [Improving Prostate Gland Segmenting Using Transformer based Architectures](https://arxiv.org/abs/2506.14844)
*Shatha Abudalou*
...
<details>
  <summary>Details</summary>
Motivation: Address inter-reader variability and cross-site domain shift in prostate MRI segmentation by evaluating transformer models' precision.

Method: Compare UNETR and SwinUNETR against 3D UNet using three training strategies (single cohort, cross-validated mixed cohort, gland size-based) on 546 MRI volumes.

Result: SwinUNETR achieved higher Dice scores (up to 0.902) than UNETR and 3D UNet, especially in gland size-based subsets.

Conclusion: Global and shifted-window self-attention in SwinUNETR reduces noise and imbalance sensitivity, enhancing clinical robustness.
...
### [128] [Foundation Artificial Intelligence Models for Health Recognition Using Face Photographs (FAHR-Face)](https://arxiv.org/abs/2506.14909)
...
TL;DR: FAHR-Face, a foundation model, was fine-tuned for biological age estimation (FAHR-FaceAge) and survival risk prediction (FAHR-FaceSurvival), demonstrating high accuracy and clinical utility.


<details>
  <summary>Details</summary>
Motivation: To leverage facial appearance as a noninvasive biomarker for health, focusing on biological age estimation and survival risk prediction in cancer patients.

Method: Two-stage fine-tuning on public and clinical datasets, with extensive testing for robustness and independence. Clinical validation involved multivariable Cox models.

Result: FAHR-FaceAge achieved a mean absolute error of 5.1 years, outperforming benchmarks. FAHR-FaceSurvival predicted mortality robustly, with the highest-risk quartile having triple the mortality. Both models showed generalizability.
...
### [129] [Recursive Variational Autoencoders for 3D Blood Vessel Generative Modeling](https://arxiv.org/abs/2506.14914)
*Paula Feldman,Miguel Fainstein,Viviana Siless,Claudio Delrieux,Emmanuel Iarussi*

Main category: eess.IV

TL;DR: A Recursive Variational Neural Network (RvNN) is developed to generate accurate and diverse 3D blood vessel models, addressing limitations of rule-based methods.
...
Method: The RvNN learns a low-dimensional manifold encoding branch connectivity and geometry features, enabling generation of new vessel geometries by sampling its latent space.

Result: The generated 3D vessel models closely resemble real data in terms of radii, length, and tortuosity, even for datasets with aneurysms.
...
### [130] [NeuroMoE: A Transformer-Based Mixture-of-Experts Framework for Multi-Modal Neurological Disorder Classification](https://arxiv.org/abs/2506.14970)
...
<details>
  <summary>Details</summary>
Motivation: Existing DL methods fail to effectively use multi-modal MRI and clinical data, limiting diagnostic performance for NDs.

Method: The framework uses transformer encoders for spatial MRI data and modality-specific experts with adaptive fusion for feature extraction.

Result: The approach outperforms baselines by over 10%, achieving 82.47% validation accuracy.

Conclusion: The proposed MoE framework shows promise for improving ND diagnosis through multi-modal learning in clinical settings.
...
### [131] [Classification of Multi-Parametric Body MRI Series Using Deep Learning](https://arxiv.org/abs/2506.15182)
*Boah Kim,Tejas Sudharshan Mathai,Kimberly Helm,Peter A. Pinto,Ronald M. Summers*

Main category: eess.IV

TL;DR: A deep learning model (DenseNet-121) is developed to classify 8 body mpMRI series types, achieving high accuracy (0.972) and F1-score (0.966), with robust performance on external datasets.
...
Result: DenseNet-121 achieves the highest accuracy (0.972) and F1-score (0.966), with performance improving as training data increases. External dataset accuracies are 0.872 and 0.810.

Conclusion: The DenseNet-121 model is highly accurate for classifying MRI series, scalable with training data, and generalizes well to external datasets.
...
### [132] [Privacy-Preserving Chest X-ray Classification in Latent Space with Homomorphically Encrypted Neural Inference](https://arxiv.org/abs/2506.15258)
*Jonghun Kim,Gyeongdeok Jo,Shinyoung Ra,Hyunjin Park*

Main category: eess.IV

TL;DR: Proposes an HE inference framework for medical images using VQGAN compression and polynomial approximations to balance privacy, computational efficiency, and accuracy.


<details>
  <summary>Details</summary>
Motivation: Medical imaging data require privacy protection; HE allows encrypted computations but is computationally expensive for large images.

Method: Uses VQGAN to compress images into latent representations, approximates activation functions with low-degree polynomials, and adapts squeeze and excitation modules.

Result: Achieves optimal balance with an 8x downsampling factor; tested on chest X-ray datasets with minor performance differences vs. unencrypted inference.

Conclusion: The framework shows strong potential for practical HE use in medical imaging despite slower inference.
...
### [133] [FedWSIDD: Federated Whole Slide Image Classification via Dataset Distillation](https://arxiv.org/abs/2506.15365)
*Haolong Jin,Shenglin Liu,Cong Cong,Qingmin Feng,Yongzhi Liu,Lina Huang,Yingzi Hu*

Main category: eess.IV

TL;DR: FedWSIDD is a federated learning method for medical image analysis, using dataset distillation to share synthetic slides instead of raw data, addressing privacy and resource heterogeneity.


<details>
  <summary>Details</summary>
Motivation: To enable collaborative WSI classification while preserving patient privacy and handling computational resource disparities across institutions.

Method: Proposes FedWSIDD, which uses dataset distillation to create synthetic slides, incorporates stain normalization, and shares these slides instead of raw data.
...
### [134] [A Real-time Endoscopic Image Denoising System](https://arxiv.org/abs/2506.15395)
...
<details>
  <summary>Details</summary>
Motivation: Single-use endoscopes with tiny sensors reduce costs and infection risks but suffer from noise due to limited photon capture and dynamic range.
...
Conclusion: The hybrid denoising approach effectively enhances image quality in ultra-compact endoscopes, balancing performance and detail preservation.
...
### [135] [Advanced cervical cancer classification: enhancing pap smear images with hybrid PMD Filter-CLAHE](https://arxiv.org/abs/2506.15489)
*Ach Khozaimi,Isnani Darti,Syaiful Anam,Wuryansari Muharini Kusumawinahyu*

Main category: eess.IV

TL;DR: The study explores how image preprocessing techniques (PMD filter, CLAHE, and a hybrid approach) improve CNN performance for cervical cancer classification, showing significant metric improvements.


<details>
  <summary>Details</summary>
Motivation: Early detection of cervical cancer is crucial, and CNNs can aid in automated screening, but their performance depends on image quality.

Method: Evaluated three preprocessing techniques on the SIPaKMeD dataset using pretrained CNN models like ResNet and EfficientNet.

Result: Hybrid PMD filter-CLAHE preprocessing improved accuracy by 13.62%, precision by 10.04%, recall by 13.08%, and F1-score by 14.34%.

Conclusion: The hybrid technique enhances Pap smear image quality and CNN performance, offering a promising approach for cervical cancer classification.
...
### [136] [Automated MRI Tumor Segmentation using hybrid U-Net with Transformer and Efficient Attention](https://arxiv.org/abs/2506.15562)
*Syed Haider Ali,Asrar Ahmad,Muhammad Ali,Asifullah Khan,Muhammad Shahban,Nadeem Shaukat*

Main category: eess.IV

TL;DR: The paper proposes a hybrid UNet-Transformer model for tumor segmentation in MRI datasets from a local hospital, achieving competitive results (Dice: 0.764, IoU: 0.736) and emphasizing the need for site-specific AI models in clinical settings.


<details>
  <summary>Details</summary>
Motivation: Public datasets lack heterogeneity for local patient populations, necessitating research on local datasets to integrate AI tumor segmentation into hospital workflows for accurate oncology treatment.

Method: A hybrid UNet-Transformer model with attention modules (efficient attention, SE blocks, CBAM, ResNeXt) was trained on 6080 local MRI images, using pretrained weights and dual GPUs for efficiency.

Result: The model achieved a Dice score of 0.764 and IoU of 0.736, showing competitive performance despite limited data.

Conclusion: Site-specific model development is crucial for clinical deployment, as demonstrated by the success of the hybrid architecture on local data.
...
### [137] [Human Motion Capture from Loose and Sparse Inertial Sensors with Garment-aware Diffusion Models](https://arxiv.org/abs/2506.15290)
...
<details>
  <summary>Details</summary>
Motivation: Existing IMU-based motion capture assumes tight sensor attachment, which is unrealistic. The paper addresses the challenge of loose sensor attachment and garment variability.

Method: Simulates IMU recordings from a garment-aware dataset, uses transformer-based diffusion models to synthesize loose IMU data, and incorporates garment parameters during training.

Result: The proposed method outperforms state-of-the-art approaches in both quantitative and qualitative evaluations.

Conclusion: The work opens a promising direction for future research in motion capture with loosely attached IMUs and garment-aware modeling.
...
### [138] [One-shot Face Sketch Synthesis in the Wild via Generative Diffusion Prior and Instruction Tuning](https://arxiv.org/abs/2506.15312)
...
<details>
  <summary>Details</summary>
Motivation: Existing face sketch synthesis methods rely on large datasets, facing issues like data scarcity and high costs. This paper aims to overcome these limitations with a one-shot approach.

Method: The method optimizes text instructions on a diffusion model using photo-sketch pairs, then uses these instructions for inference. A new benchmark, OS-Sketch, is introduced for evaluation.

Result: The proposed method successfully converts photos into realistic sketches in a one-shot context, outperforming other methods in convenience and applicability.

Conclusion: The one-shot diffusion model approach is effective for face sketch synthesis, offering practical advantages over traditional methods. The OS-Sketch dataset supports comprehensive evaluation.
...
### [139] [Nabla-R2D3: Effective and Efficient 3D Diffusion Alignment with 2D Rewards](https://arxiv.org/abs/2506.15684)
...
Result: Outperforms baselines with higher rewards and reduced prior forgetting in few steps.
...
### [140] [An accurate and revised version of optical character recognition-based speech synthesis using LabVIEW](https://arxiv.org/abs/2506.15029)
*Prateek Mehta,Anasuya Patil*

Main category: cs.SD

TL;DR: The paper introduces an OCR-based speech synthesis system for visually impaired individuals to access books of their choice, addressing limitations of Braille and audio recordings.


<details>
  <summary>Details</summary>
Motivation: Visually impaired individuals face restricted access to books due to reliance on Braille and NGO-provided audio. Speech is a more effective communication mode for them.

Method: Developed an OCR-based speech synthesis system using LabVIEW, ensuring accuracy, reliability, cost-effectiveness, and user-friendliness.

Result: The system provides a practical solution for converting text to speech, enabling blind individuals to access desired books.

Conclusion: The OCR-based speech synthesis system is a viable tool for enhancing accessibility for visually impaired individuals.
...
### [141] [SonicVerse: Multi-Task Learning for Music Feature-Informed Captioning](https://arxiv.org/abs/2506.15154)
*Anuradha Chopra,Abhinaba Roy,Dorien Herremans*

Main category: cs.SD

TL;DR: SonicVerse is a multi-task music captioning model that integrates caption generation with auxiliary music feature detection, enhancing caption quality and detail.
...
Method: A projection-based architecture transforms audio into language tokens while detecting music features via auxiliary heads, which are also projected into language tokens to enhance captioning.

Result: Incorporating music features improves caption quality and detail, enabling rich descriptions for both short fragments and longer music pieces.

Conclusion: SonicVerse effectively combines feature detection and captioning, demonstrating the value of multi-task learning for music AI applications.
...
### [142] [pycnet-audio: A Python package to support bioacoustics data processing](https://arxiv.org/abs/2506.14864)
*Zachary J. Ruff,Damon B. Lesmeister*

Main category: cs.SD

TL;DR: The paper discusses passive acoustic monitoring using ARUs and introduces pycnet-audio, a workflow for processing large acoustic datasets, built around the PNW-Cnet model for detecting wildlife vocalizations and noise.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the impracticality of manually reviewing large acoustic datasets by providing an automated solution for detecting signals of interest.

Method: The method involves deploying ARUs for extended periods, retrieving audio data, and processing it using the PNW-Cnet model within the pycnet-audio workflow.

Result: The result is a practical workflow capable of detecting vocalizations of ~80 forest wildlife species and various anthropogenic/environmental noises.

Conclusion: The conclusion highlights the utility of pycnet-audio for efficient and automated processing of large acoustic datasets in wildlife research.
...
TL;DR: A drone system using machine learning and computer vision aids visually impaired people (VIPs) in outdoor urban navigation, combining local and global planning with obstacle avoidance.


<details>
  <summary>Details</summary>
Motivation: To assist VIPs in navigating complex urban environments using drones equipped with advanced perception and planning systems.

Method: A geometric formulation with multi-DNN framework for obstacle avoidance, integrating local perception-based path planning and global GPS-based planning.
...
TL;DR: The paper introduces Robust Instant Policy (RIP), a method to improve reliability in In-Context Imitation Learning by mitigating LLM hallucination issues using Student's t-regression.


<details>
  <summary>Details</summary>
Motivation: Address the unreliability of LLM-based instant policies in robotics due to hallucinated trajectories, which deviate from demonstrations.

Method: Proposes RIP, which aggregates multiple candidate trajectories from an LLM using Student's t-distribution to ignore outliers (hallucinations).

Result: RIP outperforms state-of-the-art IL methods by at least 26% in task success rates, especially in low-data scenarios.

Conclusion: RIP enhances reliability in robotics by robustly handling LLM hallucinations, validated in simulations and real-world tasks.
...
Method: The system integrates point features and object-level landmarks with open-vocabulary semantics, uses semantic-geometric-temporal fusion for robust object association, and includes an omnidirectional loop closure module.
...
Conclusion: The proposed system enhances object-level SLAM by leveraging surround-view cameras and semantic fusion, making it more reliable for complex outdoor environments.
...
TL;DR: A neural dynamics framework combines particles and grids to model deformable objects, achieving superior performance in learning dynamics and generalization, even with limited camera views.
...
Result: Outperforms state-of-the-art simulators, generalizes to unseen instances, and aids in model-based planning.

Conclusion: The framework effectively models deformable objects and enables practical applications like manipulation tasks.
...
<details>
  <summary>Details</summary>
Motivation: Limited spatial resolution and distortion in 360° videos degrade immersive VR experiences, and conventional VSR techniques fail to address these issues due to lack of suitable datasets and models.
...
Conclusion: The work provides a robust solution for 360° video super-resolution, enhancing VR visual quality with a purpose-built model and dataset.
